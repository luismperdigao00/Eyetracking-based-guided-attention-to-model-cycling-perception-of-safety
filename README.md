...
- a pairwise comparison table, such as `comparisons.csv` or `comparisons_df.pickle`;
- an image directory, such as `images/`;
- optional gaze maps for gaze-guided experiments;
- a model configuration or command-line arguments specifying the architecture, backbone, and training setup.

The examples below show common training and evaluation commands.
