...
from egpcs.config.model_variants import (
    MODEL_VARIANT_CHOICES,
    build_model_variant_config,
    normalize_model_variant,
)
from egpcs.data.datasets import ComparisonsDataset
from egpcs.evaluation.evaluator import test
from egpcs.evaluation.explanations import _plot_roc_when_ties_off
from egpcs.models.backbones.registry import infer_vit_grid_size, resolve_backbone
from egpcs.training.setup import _build_model as build_train_model
from egpcs.training.setup import _build_transforms_and_specs
...
def build_model(args):
    ...
    if args.backbone in TRANSFORMER_BACKBONES:
        ...
        if model_variant_cfg is None:
            model_variant_cfg = build_model_variant_config(args, is_cnn_backbone=False)
